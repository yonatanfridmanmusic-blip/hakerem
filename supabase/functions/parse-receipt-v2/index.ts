...
- date: תאריך הוצאת המסמך בלבד. לעולם לא "לתשלום עד", לא תאריך פירעון, לא מועד אחרון לתשלום. תאריכים במסמכים ישראליים כתובים יום/חודש/שנה (DD/MM/YY או DD/MM/YYYY) — למשל 3/09/26 הוא 3 בספטמבר 2026. שנה דו-ספרתית פירושה 20YY (26 = 2026; לעולם לא 2003 ולא 1926).
            ...
            documents: {
              ...
              items: {
                ...
                properties: {
                  ...
                  date:               { type: "string", description: "תאריך המסמך YYYY-MM-DD (לא 'לתשלום עד'). null אם לא קיים." },
