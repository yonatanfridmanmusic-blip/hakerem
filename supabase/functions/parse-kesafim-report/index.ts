          ...
          properties: {
            ...
            rows: {
              ...
              items: {
                type: "object",
                properties: {
                  name_raw: { type: "string", description: "ערך עמודת 'נושא משני' בלבד, מילה במילה, כולל תחיליות כמו ** או 'הכ'. אל תכלול את עמודת 'נושא ראשי' (למשל 'הכנסות הורים') ואל תנרמל." },
...
const SYSTEM_PROMPT =
  ...
  "שם השורה (name_raw) הוא ערך עמודת 'נושא משני' בלבד — מילה במילה, בלי לצרף את עמודת 'נושא ראשי' (כמו 'הכנסות הורים'), בלי לתקן שגיאות ובלי להשמיט תחיליות כמו ** או 'הכ'. " +
